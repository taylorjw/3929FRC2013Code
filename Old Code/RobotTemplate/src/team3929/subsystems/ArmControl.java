...
Victor vic; //New Relay called Rspike
    ...
    public ArmControl() {
        vic = new Victor(RobotMap.DPWM_armVictor); //Sets the location for the Victor at the given point on RobotMap so that there are no numbers in the actual code
    }
   ...
   public void Forward(){
       vic.set(1); //Creates a method that sets the spike into reverse so the motor can move in reverse
