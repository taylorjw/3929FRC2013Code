...
public class ChassisSpeedController extends PIDController {
    ...
    public ChassisSpeedController(PIDSource pidsource, PIDOutput source) {
        super(Kp, Ki, Kd, pidsource, source);
